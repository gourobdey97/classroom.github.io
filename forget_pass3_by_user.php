<?php
 ...
 //   echo '<script>Code sent to your email. Check your email inbox(also Spam box) for reset your password.</script>';
    $key = $_GET['id'];

    if(isset($_REQUEST['submit'])){
        $password = $_REQUEST['password'];

        $sql = 'UPDATE `user_info` SET `user_password` = "'.$password.'" WHERE `pass_key` = "'.$key.'" ';
