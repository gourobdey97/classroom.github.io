...
$sql1 = ' SELECT * FROM `class_info` WHERE `class_info`.`class_created_by` = ' . $user_id . ' ';
...
<body>
    ...
    <hr />
    <h1 style="text-align:center;color:darkslategrey; margin-top:10px">My created classes</h1>
    <br>
    <br>
    <div class="all_class">
        <?php
        ...
        ?>
            <p class="no_class">You have not created any class yet. <a href="create_class_by_user.php">Click here</a> to join.</p>
            <?php
        } else {
            $i = 1;
